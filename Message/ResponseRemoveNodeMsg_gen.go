...
func (z *ResponseRemoveNodeMsg) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z *ResponseRemoveNodeMsg) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 5
	// write "type"
...
func (z *ResponseRemoveNodeMsg) MarshalMsg(b []byte) (o []byte, err error) {
...
func (z *ResponseRemoveNodeMsg) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z *ResponseRemoveNodeMsg) Msgsize() (s int) {
