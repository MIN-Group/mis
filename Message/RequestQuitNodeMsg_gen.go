...
func (z *RequestQuitNodeMsg) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z RequestQuitNodeMsg) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 3
	// write "type"
...
func (z RequestQuitNodeMsg) MarshalMsg(b []byte) (o []byte, err error) {
...
func (z *RequestQuitNodeMsg) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z RequestQuitNodeMsg) Msgsize() (s int) {
