...
func (z *RequestRemoveNodeMsg) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z RequestRemoveNodeMsg) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 3
	// write "type"
...
func (z RequestRemoveNodeMsg) MarshalMsg(b []byte) (o []byte, err error) {
...
func (z *RequestRemoveNodeMsg) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z RequestRemoveNodeMsg) Msgsize() (s int) {
	s = 1 + 5 + msgp.StringPrefixSize + len(z.Type) + 7 + msgp.StringPrefixSize + len(z.Pubkey) + 7 + msgp.Uint64Size
	return
}
