...
func (z *IdentityTransformation) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z *IdentityTransformation) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 5
	// write "type"
...
func (z *IdentityTransformation) MarshalMsg(b []byte) (o []byte, err error) {
...
func (z *IdentityTransformation) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
func (z *IdentityTransformation) Msgsize() (s int) {
	s = 1 + 5 + msgp.StringPrefixSize + len(z.Type) + 7 + msgp.StringPrefixSize + len(z.Pubkey) + 7 + msgp.StringPrefixSize + len(z.NodeID) + 3 + msgp.StringPrefixSize + len(z.IPAddr) + 5 + msgp.IntSize
	return
}
